package com.patricio.pelisapp.ui.moviedetails
...
import com.patricio.pelisapp.databinding.FragmentMovieDetailBinding
...
class MovieDetailFragment : Fragment(R.layout.fragment_movie_detail) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.txtLanguaje.text = "Languaje ${args.languaje}"
