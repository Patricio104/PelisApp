package com.patricio.pelisapp.ui.movie.adapters
...
import com.patricio.pelisapp.core.BaseViewModel
import com.patricio.pelisapp.data.model.Movie
import com.patricio.pelisapp.databinding.MovieItemBinding

class MovieAdapter(
        private val movieList: List<Movie>,
        private val itemClickListener: OnMovieClickListener) : RecyclerView.Adapter<BaseViewModel<*>>() {
    ...
    private inner class MoviesViewHolder(
            ...
            val context: Context
    ) : BaseViewModel<Movie>(binding.root) {
